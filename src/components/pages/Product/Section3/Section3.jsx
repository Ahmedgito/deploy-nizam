...
const Section3 = () => {
  return (
    ...
    {/* {Desktop-Section} */}
    <section className="md:flex hidden flex-col md:flex-row justify-between items-center mt-20 py-10 px-6 md:px-16 bg-white">
      
      {/* Left Column: Text Section */}
      <div className="md:w-1/2 mb-10 pl-20 md:mb-0">
        <h2 className="text-4xl md:text-5xl font-bold text-[#db7216] leading-tight">
          CHECK OUR <br /> COMPLETE RANGE <br /> ONLINE
        </h2>
        <h3 className="mt-4 text-2xl font-semibold text-gray-700">ON OUR DIGITAL LIBRARY</h3>
        <p className="mt-4 pr-36 text-2xl text-black leading-relaxed">
